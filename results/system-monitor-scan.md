...
**Description:** Skill name 'system_monitor' is invalid. Agent skills require lowercase letters, numbers, and hyphens only, with a maximum length of 64 characters.
